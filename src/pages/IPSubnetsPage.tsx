              ...
              <div className="flex items-start justify-between gap-2">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="font-mono font-semibold text-gray-800 dark:text-gray-100">{s.prefix}*</p>
                    <p className="text-sm text-gray-600 dark:text-gray-300 truncate">{s.label}</p>
                    {s.notes && <p className="text-xs text-gray-400 dark:text-gray-500 truncate">{s.notes}</p>}
                  </div>
                </div>
                {canManage && (
                  <div className="flex gap-1 shrink-0">
                    <button onClick={() => openEdit(s)} className="p-1.5 text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-900/40 rounded-lg" title="Edit">
                      <Pencil size={16} />
                    </button>
