  ...
  return (
    <div className="gbb-login-shell min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <Server
          className="absolute top-20 left-20 text-[#ffc800]/20 hidden lg:block"
          size={64}
        />
        <Network
          className="absolute bottom-32 right-24 text-[#ffc800]/20 hidden lg:block"
          size={56}
        />
        <Database
          className="absolute top-1/2 right-16 text-[#ffc800]/15 hidden lg:block"
          size={48}
        />
      </div>
        ...
        <div className="gbb-login-panel backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="px-8 py-8 space-y-5">
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-[var(--gbb-text)]">
                Email Address
              </label>
              <div className="relative">
                ...
                <TextInput
                  ...
                  placeholder="you@gohbetochbank.com"
                  className="pl-10"
                />
              </div>
            </div>
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="gbb-icon-button absolute right-1 top-1/2 min-h-0 min-w-0 -translate-y-1/2 text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
                >
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-[var(--gbb-text-muted)] cursor-pointer">
                <input
                  type="checkbox"
                  checked={remember}
              ...
              <Link
                ...
                className="font-medium text-[#343494] dark:text-[#b7b7ff] hover:underline"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <p className="text-center text-xs text-[var(--gbb-text-muted)]">
