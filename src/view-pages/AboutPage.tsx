    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            System information and developer details
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-brand-600 to-brand-500 rounded-2xl p-8 text-white shadow-lg">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <h3 className="text-lg text-gold-400 font-semibold">
              Asset Inventory Management Portal
            </h3>
            <p className="text-white/80 text-sm mt-2">
              Version 1.0.0 - Developed In-house
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-card border border-brand-600 p-6">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          The Goh Betoch Bank Asset Inventory Management Portal is a
          comprehensive web-based application designed to manage and track all
          IT assets across the bank's infrastructure. The system provides
          centralized registration and management of PCs, licenses, network
          devices, and servers, with powerful reporting, filtering, and
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
          <div className="flex items-start gap-3 bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-300 mt-1">
                Track all servers with environment, resources, and host location
                details.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3 bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-300 mt-1">
                Register workstations with full network and asset tag tracking.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3 bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-300 mt-1">
                Track all software licenses with expiry alerts and vendor
                management.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3 bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-300 mt-1">
                Register all network devices, UPS, ACs, CCTV, and infrastructure
                equipment.
              </p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-5">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
              ...
              <span>admin@gohbetbank.com</span>
            </div>
            <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
              <Phone size={16} className="text-brand-600" />{" "}
              <span>IT Department Extension</span>
            </div>
            <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
