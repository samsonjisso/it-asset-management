...
export function PCRegistrationPage({
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    if (form.access_switch_ip.trim() && !isValidIPv4(form.access_switch_ip)) {
      toast(
        "Access Switch IP Address must be a valid IPv4 address (e.g., 10.6.1.103)",
        "error",
      );
      return;
    }
    ...
    ? [
        {
          ...
          fields: [
            ...
            },
            {
              label: "Photo",
              value: viewing.image ? (
                <ZoomImage src={viewing.image} size={144} />
              ) : null,
              full: true,
            },
          ],
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Field label="Display Monitor / Serial Number">
              <TextInput
                ...
                onChange={(e) =>
                  setForm({ ...form, monitor_serial: e.target.value })
                }
            ...
            <Field
              label="Asset Tag"
              skip
              onSkip={() => setSkipAssetTag(!skipAssetTag)}
            >
              <TextInput
            ...
            <Field label="Service Tag / Serial Number">
              <TextInput
                ...
                onChange={(e) =>
                  setForm({ ...form, service_tag: e.target.value })
                }
            ...
            <Field label="Product Key / License">
              <TextInput
                ...
                onChange={(e) =>
                  setForm({ ...form, product_key: e.target.value })
                }
            ...
            <Field label="Memory Detail">
              <TextInput
                ...
                onChange={(e) =>
                  setForm({ ...form, memory_detail: e.target.value })
                }
            ...
            <Field label="Generation Detail">
              <TextInput
                ...
                onChange={(e) =>
                  setForm({ ...form, generation_detail: e.target.value })
                }
            ...
            <Field
              ...
              skip={selectedDept?.is_branch}
              onSkip={() => setSkipFloor(!skipFloor)}
            >
              <TextInput
                ...
                placeholder={
                  skipFloor || selectedDept?.is_branch
                    ? "Skipped (branch location)"
                    : "Floor number"
                }
            ...
            <Field label="Switch Port Number">
              <TextInput
                ...
                onChange={(e) =>
                  setForm({ ...form, switch_port_number: e.target.value })
                }
            ...
            <Field label="Access Switch Name">
              <TextInput
                ...
                onChange={(e) =>
                  setForm({ ...form, access_switch_name: e.target.value })
                }
            ...
            <Field label="Access Switch IP Address">
              <TextInput
                ...
                onChange={(e) =>
                  setForm({ ...form, access_switch_ip: e.target.value })
                }
            ...
            <Field label="Patch / Level Number">
              <TextInput
                ...
                onChange={(e) =>
                  setForm({ ...form, patch_level_number: e.target.value })
                }
