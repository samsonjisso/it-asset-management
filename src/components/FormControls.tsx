...
export function Button({
  ...
  const variants = {
    ...
    navy: "bg-navy-900 text-white border border-brand-950 hover:bg-navy-800 hover:border-brand-900 focus-visible:ring-2 focus-visible:ring-navy-600",
    secondary:
      "bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 hover:bg-gray-200 dark:hover:bg-gray-700 hover:border-gray-400 dark:hover:border-gray-500 focus-visible:ring-2 focus-visible:ring-gray-300",
    gold: "bg-gold-400 text-brand-950 border border-gold-600 hover:bg-gold-300 hover:border-gold-700 font-semibold focus-visible:ring-2 focus-visible:ring-gold-200",
    danger:
      "bg-red-600 text-white border border-red-800 hover:bg-red-500 hover:border-red-700 focus-visible:ring-2 focus-visible:ring-red-300",
    ghost:
      "text-gray-600 dark:text-gray-300 border border-transparent hover:bg-gray-100 dark:hover:bg-gray-800 hover:border-gray-200 dark:hover:border-gray-700 focus-visible:ring-2 focus-visible:ring-gray-200",
    outline:
