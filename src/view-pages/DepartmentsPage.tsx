        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {departments.length} departments/branches
            </p>
          </div>
        </div>
        {canManage && (
          ...
          {departments.map((dept) => (
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-10 h-10 rounded-lg flex items-center justify-center ${dept.is_branch ? "bg-amber-50 text-amber-600" : "bg-brand-50 dark:bg-brand-900/40 text-brand-600"}`}
                  >
                    {dept.is_branch ? (
                      <MapPin size={20} />
                    ) : (
                  ...
                  <div>
                    ...
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full font-medium ${dept.is_branch ? "bg-amber-100 text-amber-700" : "bg-brand-100 dark:bg-brand-900/50 text-brand-700 dark:text-brand-300"}`}
                    >
